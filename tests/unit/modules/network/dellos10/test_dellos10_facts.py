...
from ansible_collections.dellemc_networking.os10.plugins.modules import dellos10_facts
...
class TestDellos10Facts(TestDellos10Module):
    ...
    def setUp(self):
        ...
        self.mock_run_command = patch(
            'ansible_collections.dellemc_networking.os10.plugins.modules.dellos10_facts.run_commands')
